 ...
 * @author yonay
 */
@WebServlet(name = "SessionFromView", urlPatterns = {"/SessionFromView"})
public class SessionFromView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SessionFromView</title>");            
            out.println("</head>");
            out.println("<body>");
